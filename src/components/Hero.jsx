      ...
      <div className='flex items-center justify-between bg-white rounded text-gray-600  max-w-xl  pl-4 mx-4 sm:mx-auto'>
        ...
        <div className='flex items-center'>
            ...
            placeholder='Search for jobs'
             className="max-sm:text-xs p-2 rounded outline-none w-full text-gray-700 placeholder-gray-500" ref={titleRef}/>
        ...
        <div className='flex items-center'>
            ...
            placeholder='Location'
             className="max-sm:text-xs p-2 rounded outline-none w-full text-gray-700 placeholder-gray-500" ref={locationRef}/>
            {/* className='max-sm:text-xs p-2 rounded outline-none w-full' /> */}
        </div>
