    ...
    <div className='min-h-screen'>
        ...
        <div className='shadow py-4 '>
            <div className='px-5  flex justify-between items-center'>
                <img onClick={e=> navigate('/')} className='max-sm:w-32 cuusor pointer ' src={assets.logo} alt="" />
        ...
        <div className='flex items-start'>
            ...
            {/* left sidebar with options with add job manage jobs and view applications  */}
            <div className='inline-block min-h-screen border-r-2'>
                <ul className='flex flex-col items-start pt-5 text-gray-800'>
                    <NavLink className={({isActive})=>`flex items-center p-3 sm:px-6 gap-2 w-full hovor:bg-gray-100
